...
export default function Notice() {
    ...
    const getboard = async () => {
        const {data} = await axios.post(`${apiUrl}/list/bbs`,{category:'공지사항',page:page})
        console.log(data);
        setList(data.list);
    ...
    const getMyList = async() => {
        const {data} = await axios.post(`${apiUrl}/list/bbs`,{category:'공지사항',page:page,user_id:sessionStorage.getItem('user_id')})
        console.log(data);
        setMyList(data.list);
