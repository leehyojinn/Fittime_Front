...
const centerProfileSample = {
    ...
    trainers: [
      { user_id: 'trainer1', user_name: '김트레이너', profile_image: '/member.png', contact: '010-2222-3333', rating: 4.8 }
    ]
  };
const mockCenterReservations = [
  { reservation_idx: 1, member_name: '홍길동', contact: '010-1234-5678', product_name: '헬스 1개월', date: '2025-05-21', start_time: '10:00', end_time: '11:00', trainer_name: '', status: '예약완료' },
  { reservation_idx: 2, member_name: '이영희', contact: '010-9876-5432', product_name: 'PT 10회', date: '2025-05-25', start_time: '15:00', end_time: '16:00', trainer_name: '김트레이너', status: '예약완료' }
];
...
const CenterMyPage = () => {
  ...
  const [center, setCenter] = useState(centerProfileSample);
  const [mainImage, setMainImage] = useState(center.main_image);
  const [subImages, setSubImages] = useState(center.sub_images);
        ...
        <div className='wrap padding_120_0'>
            ...
            <div className="mypage-profile">
                ...
                <div className="mypage-profile-row">
                    ...
                    {editMode ? <input className='width_fit' defaultValue={center.contact} /> : <span className="label font_weight_400">{center.contact}</span>}
                </div>
                <div className="mypage-profile-row">
                    <span className="label font_weight_500">소개</span>
                    {editMode ? <textarea className='width_fit' defaultValue={center.intro} /> : <span className="label font_weight_400">{center.intro}</span>}
                </div>
                <div className="mypage-profile-row">
                ...
                <div className="mypage-profile-row"><span className="label font_weight_500">운영시간</span><span className="label font_weight_400">{center.open_hour}~{center.close_hour}</span></div>
            ...
            <div className="mypage-section">
                ...
                <button className="btn white_color label"><FaPlus /> 트레이너 추가</button>
            </div>
            <div className="mypage-section">
