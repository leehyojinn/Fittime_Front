...
function LoginPage() {
    ...
    const login = async () => {
            ...
            if (data && data.login && data.success) {
                ...
                <div className="flex column gap_10 align_center">
                    ...
                    <div className='flex column gap_10 align_center justify_con_center'>
                        ...
                        <div className='position_rel width_300'>
                            <input type={passwordVisible ? "text" : "password"} name='password' value={form.password} onKeyUp={keyHandler} onChange={handleIdChange} onFocus={handlePwFocus}/>
